  ...
  <section class="skip-panel">
    <button class="skip-head" @click="skipPanelCollapsed = !skipPanelCollapsed">
      <svg
        ...
        height="18"
      >
        <path d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 010 1.971l-11.54 6.347a1.125 1.125 0 01-1.667-.985V5.653zM19.5 5.25a.75.75 0 01.75.75v12a.75.75 0 01-1.5 0V6a.75.75 0 01.75-.75z" />
      </svg>
