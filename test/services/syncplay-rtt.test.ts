...
// (src/renderer/src/composables/use-syncplay-client.ts:1411). Upstream gates the same shift on the same flag
...
// #220 echo guard (src/main/syncplay.ts:862-870) compares the element's echoed
