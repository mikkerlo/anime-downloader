...
describe('two-peer syncplay harness', () => {
  ...
  it('defaults the bind gap to a clean positive one — not 0, not the drag regime', () => {
    ...
    // `syncplay-two-peer-adoption.test.ts:302` run under their own
    // `syncplay-two-peer-adoption.test.ts:119 ("bindGapMs: 30_000")` and
    // `syncplay-two-peer-adoption.test.ts:291 ("bindGapMs: 30_000")` seats, the
  ...
  /**
   * Seat the 500 ms switch scenario `syncplay-two-peer-adoption.test.ts:362`
 ...
 * `test/services/syncplay-two-peer-adoption.test.ts:307`,
 * `test/services/syncplay-two-peer-adoption.test.ts:407` and elsewhere. A
