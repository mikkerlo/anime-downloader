...
describe('two-peer syncplay harness', () => {
  ...
  it('defaults the bind gap to a clean positive one — not 0, not the drag regime', () => {
    ...
    // `syncplay-two-peer-adoption.test.ts:290` run under their own
    // `syncplay-two-peer-adoption.test.ts:119 ("bindGapMs: 30_000")` and
    // `syncplay-two-peer-adoption.test.ts:279 ("bindGapMs: 30_000")` seats, the
  ...
  /**
   * Seat the 500 ms switch scenario `syncplay-two-peer-adoption.test.ts:350`
 ...
 * `test/services/syncplay-two-peer-adoption.test.ts:295`,
 * `test/services/syncplay-two-peer-adoption.test.ts:395` and elsewhere. A
